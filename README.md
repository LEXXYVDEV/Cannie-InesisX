...
<div align="center"><img src="https://files.catbox.moe/92c880.png"></div>
...
```json
"dependencies": {
    "baileys": "github:LEXXYVDEV/Cannie-InesisX"
}
```
or install in terminal:
```
npm install "@whiskeysockets/baileys": "github:LEXXYVDEV/Cannie-InesisX
```
